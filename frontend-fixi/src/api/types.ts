...
// dependencies / availability / approved_contractors are still explicitly
// out of scope for this phase (WorkGraph/VoicePanel/provenance badges build
// on them later) -- typed as unknown[] here so CaseSnapshot is complete and
// nothing needs `as any` when reading the other fields. work_orders,
// appointments, latest_reports and pending_actions ARE typed (Costs tab /
